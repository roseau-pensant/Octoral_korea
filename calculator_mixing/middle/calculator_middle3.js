...
$('#reset').click(function () {
    ...
    if(changePH254 == "sanding"){
        $("#TA910_change_sanding").html((TA910_sanding*water_ph254_ta910).toFixed(1));
    }else if(changePH254 == "nonsanding"){
        $("#TA910_change_sanding").html((TA910_Nonsanding*water_ph254_pa65).toFixed(1));
    }
